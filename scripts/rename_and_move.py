...
def main(artifact_dir: str, output_root: str, move_map: Dict[str, str]) -> None:
...
if __name__ == "__main__":
    if len(sys.argv) == 4:
        ...
        move_map: Dict[str, str] = json.loads(sys.argv[3])
        main(artifact_dir, output_root, move_map)
    else:
        print("Usage: rename_and_move.py <artifact_dir> <output_root> '<json_map>'")
        sys.exit(1)
